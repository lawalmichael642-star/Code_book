        ...
        <main className="mx-auto max-w-7xl px-4 md:px-6 py-12">
            <div className="text-center">
                ...
                onClick={()=> navigate ("/product")}>
                    <p className="dark:text-white">Back to products.</p>
                </button>
            </div>
        </main>
    )
...
return(
    <main className="mx-auto max-w-7xl px-4 md:px-6 py-12">
        ...
        <div>
            <h1 className=" text-3xl dark:text-white mb-4">{product.name}</h1>
            ...
            <div className="mb-6">
                ...
                <p className="text-sm text-gray-600 mt-2 dark:text-gray-400 ">{product.in_stock ? "In stock" : "Out of stock"}</p>
            ...
            <div className="mb-6">
                ...
                <p className="text-lg font-semibold dark:text-white mb-2">{product.overview}</p>
            </div>
            <div className="mb-6">
                <h3 className="text-lg font-semibold dark:text-white mb-2">Description</h3>
                <p className="text-gray-700 dark:text-gray-300">{product.long_description}</p>
            </div>
            <button
