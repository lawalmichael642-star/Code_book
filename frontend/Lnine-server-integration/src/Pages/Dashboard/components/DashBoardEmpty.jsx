...
const DashboardEmpty = () => {
  return (
    <section className='text-xl text-center max-w-4xl mx-auto my-10 py-5 dark:text-slate-100 border dark:border-slate-700 rounded'>
        ...
        <Link to="/products" className='text-white bg-rose-600 hover:bg-rose-700 rounded-lg text-lg px-5 py-2.5 mr-2 mb-2 dark:bg-rose-600 dark:hover:bg-rose-700 focus:outline-none inline-flex items-center gap-2'>
        Continue Shopping 
        <BiCart/>
        </Link>
