...
const Hero = () => {
    return(
        <section className="flex flex-col lg:flex-row dark:text-slate-100 items-center px-12.5 gap-6">
            ...
            to="/products"
            type="button"
            className="text-white bg-rose-600 hover:bg-rose-700 focus:ring-rose-500 font-medium rounded-lg text-base px-5 py-2.5 mr-2 focus:outline-none dark:focus:ring-rose-800"
            >
                Explore eBooks
            </Link>
            </div>
