          ...
          <p className="my-3 ">
            ...
            {inCart && (
              <button
                ...
                className={`inline-flex items-center py-2 px-5 cursor-pointer text-lg font-medium text-center text-white bg-rose-600 rounded-lg hover:bg-red-700 ${product.in_stock ? "" : "cursor-not-allowed"}`}
                disabled={!product.in_stock}
              >
                Remove Item
                <i className="ml-1">
